...
import { TWIG_COMPONENT_REGEX, TWIG_ATTRIBUTE_REGEX } from '../utils/constants';
...
export class TwigComponentFormattingProvider implements vscode.DocumentFormattingEditProvider, vscode.DocumentRangeFormattingEditProvider {
	...
	private formatTag(
		...
		// Format the tag with attributes on separate lines
		...
		// Based on the screenshot, attributes should be indented with 4 spaces
